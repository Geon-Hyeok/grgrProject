...
<body>
   ...
   <a href="${pageContext.request.contextPath}/index.html" class="top-logo">
   <img src="${pageContext.request.contextPath}/assets/images/logo-main.png" alt=""></a>
   ...
   <div class="full-height relative p-y-30 v-center bg-img"
                  ...
                  <div class="tab-content">
                     <div class="tab-pane fade show active mt-20 p-15"
                        ...
                        <form class="validation-inner" id="login-form3"
                           action="${pageContext.request.contextPath}/user/login-register" method="post">
      ...
      <p class="absolute bottom-15 x-0 text-center">
         <a href="${pageContext.request.contextPath}/index.html" class="text-link fs-16 m-x-15">Home</a> <a
            href="${pageContext.request.contextPath}/components.html" class="text-link fs-16 m-x-15">Components</a>
         <a href="${pageContext.request.contextPath}/sections.html" class="text-link fs-16 m-x-15">Sections</a>
         <a href="${pageContext.request.contextPath}/templates.html" class="text-link fs-16 m-x-15">Templates</a>
      </p>
   </div>
